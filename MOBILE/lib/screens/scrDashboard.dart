...
class _DashboardScreenState extends State<DashboardScreen> {
  ...
  Widget _buildResumoCards() {
    ...
    final horasDisponiveis = resumo['horasDisponiveis'] ?? 0;
    final horasReservadas = resumo['horasReservadas'] ?? 0;
    ...
    return GridView.count(
      ...
      children: [
        ...
        _buildResumoCard(
          titulo: 'Horas Trabalhar',
          valor: _formatarHoras(horasDisponiveis.toDouble()+horasReservadas.toDouble()),
          detalhes: [
            'Disponíveis: ${_formatarHoras(horasDisponiveis.toDouble())}',
            'Reservadas: ${_formatarHoras(horasReservadas.toDouble())}',
          ],
        ...
        children: [
          ...
          Padding(
            ...
            child: SingleChildScrollView(
              ...
              child: SizedBox(
                // Largura dinâmica baseada na quantidade de itens
                width: (faturamentoPorPeriodo.length * 50)
                    .toDouble(), // Ajuste o multiplicador conforme necessário
                height: 200,
                child: BarChart(
                  BarChartData(
                      ...
                      bottomTitles: AxisTitles(
                        sideTitles: SideTitles(
                          ...
                          getTitlesWidget: (value, meta) {
                            ...
                            if (index >= 0 &&
                                index < faturamentoPorPeriodo.length) {
                    ...
                    barGroups: faturamentoPorPeriodo
                        .asMap()
                        .entries
  ...
  Widget _buildServicoTile(Map<String, dynamic> servico) {
    ...
    final valorTotal = (servico['valorTotal'] ?? 0).toDouble();
      ...
      child: Row(
        children: [
          Container(
            ...
            child: const Icon(Icons.build, size: 16, color: Color(0xFF4A5C6B)),
          ),
